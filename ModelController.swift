...
class ModelController {
          ...
          fileprivate (set) var topQuestions: [Question] = ModelController.createQuestions()
...
private extension ModelController {
     class func createQuestions() -> [Question] {
          ...
          let question2: Question = {
               ...
               let owner = User(name: "Daniel Storm", aboutMe: "Developing iOS applications to help you waste time, effectively. Latest application: Zero Views", profilePictureName: "DanielStorm", reputation: 194)
          ...
          let question3: Question = {
               ...
               let body = "There are lots of drink mixes that come in powdered form: protein powders, meal replacement shake mixes, etc. Usually these come in a big container of powder with a little scoop, and you scoop out the right amount and mix it with water. How can I carry some single serving sizes of powder with me to mix with water while I'm on the go? I thought about using ziploc bags but it's hard to pour from the bag into the water cup without spilling powder everywhere."
               let owner = User(name: "user939259", aboutMe: "Developing iOS applications to help you waste time, effectively. Latest application: Zero Views", profilePictureName: "user939259", reputation: 153)
